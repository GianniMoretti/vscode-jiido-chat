...
export class UserInfoStore extends Disposable {
	...
	static INTERNAL_ORG_STORAGE_KEY = 'exp.jiido.internalOrg';
	static SKU_STORAGE_KEY = 'exp.jiido.sku';
	static IS_FCV1_STORAGE_KEY = 'exp.jiido.isFcv1';
	static IS_SN_STORAGE_KEY = 'exp.jiido.isSn';
	static IS_VSCODE_TEAM_MEMBER_STORAGE_KEY = 'exp.jiido.isVscodeTeamMember';
	static ORGANIZATION_LIST_STORAGE_KEY = 'exp.jiido.organizationList';
